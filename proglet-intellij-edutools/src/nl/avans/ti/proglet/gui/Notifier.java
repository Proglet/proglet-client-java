...
public class Notifier {
    private final NotificationGroup NOTIFICATION_GROUP = new NotificationGroup("Proglet", NotificationDisplayType.BALLOON, true);
    ...
    public Notification error(Project project, String content) {
